...
class ClinicService{
  ...
  static List<ClinicService> getSampleServices(){
    return [
      ...
      ClinicService(name: 'Boarding'),
      ClinicService(name: 'Bathing and Grooming'),
      ClinicService(name: 'Dog'),
      ClinicService(name: 'Cat'),
      ClinicService(name: 'Snake'),
      ClinicService(name: 'Bird'),
      ClinicService(name: 'Fish'),
      ClinicService(name: 'Turtle'),
      ClinicService(name: 'Lizard'),
      ClinicService(name: 'Worms'),
      ClinicService(name: 'Monkey'),
      ClinicService(name: 'Chicken'),
      ClinicService(name: 'Mouse'),
    ];
  }
